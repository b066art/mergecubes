...
namespace EasyMobile.PlayerMaker.Actions
{
    ...
    public class Advertising_GetDefaultBannerAdNetwork : FsmStateAction
    {
        ...
        {
            AdSettings.DefaultAdNetworks defaultNetworks = new AdSettings.DefaultAdNetworks(BannerAdNetwork.None, InterstitialAdNetwork.None, RewardedAdNetwork.None, RewardedInterstitialAdNetwork.None);
